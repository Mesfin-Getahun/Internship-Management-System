...
let companyRatingSchemaPromise = null;

export const ensureCompanyRatingTables = async (connection = db) => {
  if (companyRatingSchemaPromise) {
    return companyRatingSchemaPromise;
  }

  companyRatingSchemaPromise = (async () => {
    ...
    companyRatingSchemaPromise = null;
    throw error;
  });
