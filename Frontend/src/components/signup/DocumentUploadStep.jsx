      ...
      <div
        className={`relative border-2 border-dashed rounded-xl p-6 transition-all text-center ${
          formData[field]
            ...
            : "border-slate-200 hover:border-blue-900 bg-slate-50"
        }`}
      >
        <input
          type="file"
        ...
        <div className="flex flex-col items-center">
          {formData[field] ? (
            <>
              <div className="text-green-500 mb-2" style={{ fontSize: 28 }}>
                ✅
              </div>
            ...
            <>
              <div className="text-slate-400 mb-2" style={{ fontSize: 28 }}>
                ⬆️
              </div>
      ...
      <div className="pt-6 border-t border-slate-100">
        <label className="flex items-start gap-3 cursor-pointer group">
          ...
          <span className="text-sm text-slate-600 select-none group-hover:text-slate-900 transition-colors">
            ...
            comply with university internship regulations.
          </span>
        </label>
        {errors.agreed && (
