...
import { faUsers, faChalkboardTeacher, faUniversity, faBuilding, faBriefcase, faHourglassHalf } from '@fortawesome/free-solid-svg-icons';

const AdminOverview = () => {
  const stats = [
    { label: 'Total Students', val: '4,520', icon: faUsers, color: 'indigo' },
    { label: 'Total Mentors', val: '184', icon: faChalkboardTeacher, color: 'blue' },
    { label: 'Active Faculties', val: '6', icon: faUniversity, color: 'emerald' },
    { label: 'Organizations', val: '124', icon: faBuilding, color: 'slate' },
    { label: 'Active Placements', val: '842', icon: faBriefcase, color: 'indigo' },
    { label: 'Pending Orgs', val: '18', icon: faHourglassHalf, color: 'amber' }
  ];
