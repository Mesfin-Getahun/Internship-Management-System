...
const applicationsData = [
  { 
    ...
    status: 'Accepted',
    statusHistory: [
      { status: 'Applied', date: 'Oct 22, 2023' },
      { status: 'Under Review', date: 'Oct 24, 2023' },
      { status: 'Accepted', date: 'Nov 05, 2023' },
    ]
  },
  { 
    ...
    status: 'Under Review',
    statusHistory: [
      { status: 'Applied', date: 'Oct 20, 2023' },
      { status: 'Under Review', date: 'Oct 21, 2023' },
    ]
  },
  { 
    ...
    status: 'Rejected',
    statusHistory: [
      { status: 'Applied', date: 'Oct 18, 2023' },
      { status: 'Under Review', date: 'Oct 19, 2023' },
      { status: 'Rejected', date: 'Oct 20, 2023' },
    ]
  },
  { 
    ...
    status: 'Applied',
    statusHistory: [
      { status: 'Applied', date: 'Oct 15, 2023' },
    ]
  },
];
