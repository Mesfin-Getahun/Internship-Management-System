      ...
      <div className="animate-fade-in space-y-6">
        ...
        <div className="p-8 bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-800 rounded-3xl">
          ...
          <ul className="space-y-2">
            {[
              'You may apply while you have no current internship placement.',
              'Once one company accepts you, new applications are disabled.',
              'If the accepted placement is unsuitable, you may cancel it within 7 days from Active Internship Status.',
              'Other pending applications are withdrawn after acceptance.',
            ].map((text, i) => (
