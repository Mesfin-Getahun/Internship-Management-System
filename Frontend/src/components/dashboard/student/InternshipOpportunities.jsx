...
const InternshipOpportunities = () => {
  ...
  //     desc: "Join our mobile money team to help build the next generation of financial services.",
  ...
  //     desc: "Support the regional infrastructure team in maintaining core 4G/5G networks.",
  //     skills: "Cisco, TCP/IP, Linux",
  //     duration: "4 Months",
  //     applied: true,
  //   },
  //   {
  ...
  //     desc: "Help modernize internal portals using cutting-edge web technologies.",
  ...
  //   {
  //     id: 4,
  //     title: "Cloud Systems Assistant",
  //     org: "Hybrid Systems",
  //     loc: "Remote",
  //     deadline: "Oct 25, 2023",
  //     desc: "Work with our AWS team to automate infrastructure deployment pipelines.",
    ...
    <div className="animate-fade-in space-y-8">
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            Discover and apply for curated roles matching your BIT curriculum.
          </p>
        </div>
        <div className="w-full sm:w-auto flex gap-3">
          <div className="relative flex-grow sm:flex-none">
            ...
            <input
              ...
              className="w-full sm:w-64 pl-10 pr-4 py-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
        {opportunities.map((opp) => (
          <div
            key={opp.internship_id}
            className="bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-xl transition-all group flex flex-col relative overflow-hidden"
          >
            ...
            <h4 className="text-xl font-bold text-slate-800 dark:text-white mb-2 group-hover:text-blue-600 transition-colors">
              {opp.title}
            </h4>
            <p className="text-blue-600 dark:text-blue-400 text-xs font-bold uppercase tracking-wider mb-4">
              {opp.org}
            </p>
            ...
            <div className="p-8 border-b border-slate-100 dark:border-slate-800 flex justify-between items-start bg-slate-50/50 dark:bg-slate-800/30">
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-blue-600 dark:text-blue-400 font-bold text-sm uppercase mt-1">
                    {selectedInternship.org}
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="p-8 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30">
              {selectedInternship.applied ? (
                <div className="p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-800/30 rounded-2xl flex items-center gap-4">
                  ...
                  <p className="text-amber-800 dark:text-amber-400 text-sm font-bold italic">
                ...
                <button
                  onClick={() =>
                    navigate(
                      `/student/apply/${selectedInternship.internship_id}`
                    )
                  }
