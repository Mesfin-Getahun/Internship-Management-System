...
const MentorNavbar = ({ onMenuClick }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 h-20 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 z-50 px-4 sm:px-8 flex items-center justify-between transition-colors">
      <div className="flex items-center gap-3 sm:gap-4 min-w-0">
        ...
        <div className="flex flex-col min-w-0">
          <span className="font-extrabold text-base sm:text-xl tracking-tight text-slate-800 dark:text-white leading-none uppercase truncate">BiT Mentor Portal</span>
