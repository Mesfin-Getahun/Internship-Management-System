    ...
    <Card className="mb-5 p-0">
      ...
      <View className="mb-4 flex-row items-start justify-between">
        <View className="flex-1 pr-3">
          <Text className="mb-1 text-xs font-semibold uppercase tracking-[1.5px] text-slate-400">
            Internship Status
          </Text>
          <Text className="text-xl font-bold text-slate-800">{organization}</Text>
          <Text className="mt-1 text-base font-medium text-slate-600">{position}</Text>
        </View>
        <Badge status={status} />
      </View>
      ...
      <View className="rounded-2xl bg-slate-50 p-4">
        <View className="mb-2 flex-row items-center">
          ...
          <Text className="ml-2 text-sm text-slate-600">{duration}</Text>
        </View>
